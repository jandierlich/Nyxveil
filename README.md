...
- **Waffen-Fusion**: Zwei voll ausgebaute, zusammengehörige Waffen lassen
  sich zu einer einzigen, deutlich stärkeren Waffe verschmelzen
  (Lanze+Schwarm → Lanzenschwarm, Nova-Blüte+Aegis-Ring → Sternenkranz).
- **Seltene Relikte**: permanente, spielverändernde Passiv-Effekte, die
  Bosse und (sehr selten) normale Gegner fallen lassen.
- **Echo des Kerns**: Der erste Tod pro Lauf rettet dich einmalig mit
  halber Integrität zurück ins Geschehen statt sofort zu beenden.
- **Lore-Fragmente**: kurze, atmosphärische Textzeilen bei Meilensteinen
  (erster Bosskill, erster Schleier, Wellen 10/20/30/40).
...
## Letzter vollständiger Check (dieser Stand)

Beim finalen Durchgang gefunden und behoben:
- Fusionswaffen (Lanzenschwarm, Sternenkranz) waren nach der Fusion fest
  auf Stufe 1 eingefroren — es gab keinen Weg, sie weiter auszubauen.
  Jetzt wie alle anderen Waffen bis Stufe 5 steigerbar.
- Aegis-Ring und Sternenkranz teilten sich intern dieselbe
  Rotations-Variable, was im (seltenen) Fall, dass beide gleichzeitig
  aktiv sind, zu verschmelzenden Drehungen geführt hätte — jetzt
  getrennt.
- Vollständig geprüft: Syntax, alle referenzierten IDs, HTML-Balance,
  alle neuen Funktionsaufrufe gegen ihre Definitionen, keine externen
  Verbindungen, Manifest gültig.
